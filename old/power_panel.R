...
data$Response_Type = factor(data$Response_Type,
                            ...
                            labels=c(
                              ...
                              "Prepared for how to replace a transformer\npotentially damaged by GICs",
                              ...
                              "Practiced a 'blackstart' procedures in\ncase of an outage"
                            )
)
...
plot1 = ggplot(summarised_data, 
  ...
  labs(colour=NULL,
       title = "(A) Long-Term Pre-Event Decisions Taken",
...
data$Response_Type = factor(data$Response_Type,
                            ...
                            labels=c(
                              ...
                              "Increased reactive\npower reserves",
                              "Brought more generation\ncapacity online.",
                              "Ceased power transfers to\nother networks",
...
plot2 = ggplot(summarised_data, 
  ...
  theme(legend.position = 'bottom') +
  labs(colour=NULL,
       title = "(B) Short-Term Pre-Event Decisions Taken",
       subtitle = "These are decisions taken after a space weather forecast has been issued.",
       x = NULL, y = "Responses",
       fill="Number of Employees") +
  theme(panel.spacing = unit(0.6, "lines")) +
...
data$Response_Type = factor(data$Response_Type,
                            ...
                            labels=c(
                              "Reduced loads on transformers, lines\nand other assets (load reduction)",
                              "Implemented line switching/\nrearrangement",
                              "Activated GIC blocking devices\nfor vulnerable transformers",
                              "Network reconfiguration to take vulnerable\ntransformers, lines and other assets offline",
                              "Network reconfiguration to bring more\ntransformers, lines and other assets online",
                              "Increased reactive power\nreserves",
                              "Brought more generation capacity\nonline (if available within your network)",
                              "Ceased power transfers to\nother networks",
                              "Canceled routine maintenance of\nnetwork to bring more assets online",
...
plot3 = ggplot(summarised_data, 
  ...
  theme(legend.position = 'bottom') +
  labs(colour=NULL,
       title = "(C) During-Event Decisions Taken",
       subtitle = "These are decisions taken after a space weather forecast has been issued.",
       x = NULL, y = "Responses",
       fill="Employees") +
  theme(panel.spacing = unit(0.6, "lines")) +
...
data$Response_Type = factor(data$Response_Type,
                            ...
                            labels=c(
                              ...
                              "Liaised with other operators to\nshare data",
                              "Liaised with other operators to\nshare experiences",
                              "Revised preparation plans for\nfuture events",
                              "Undertaken new modeling and\nsimulation activities",
                              #"If you carried out options not listed here, please report them in the box below",#
                              "Physically replaced exposed assets with\nnew components (<$10k in value).",
                              "Physically replaced exposed assets with\nnew components ($10-100k in value).",
                              "Physically replaced exposed assets with\nnew components ($100k-$1m in value).",
                              "Physically replaced exposed assets with\nnew components (>$1m in value)."
                            )
)
...
plot4 = ggplot(summarised_data, 
  ...
  theme(legend.position = 'bottom') +
  labs(colour=NULL,
       title = "(D) Post-Event Decisions Taken",
       subtitle = "These are decisions taken after a space weather forecast has been issued.",
       x = NULL, y = "Responses",
       fill="Employees") +
  theme(panel.spacing = unit(0.6, "lines")) + 
